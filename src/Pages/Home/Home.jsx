...
import uaeCard from "../../assets/home1.jpeg";
...
const Home = () => {
  ...
  return (
    <div className="bg-black">
      <Navbar />
      <section
  className="relative flex bg-no-repeat h-screen"
  style={{
...
>
  <div className="mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
    <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right ml-auto"> {/* Added ml-auto for right alignment */}
